...
enum node_kind  { EXT_DEF_LIST,EXT_VAR_DEF,FUNC_DEF,FUNC_DEC,EXT_DEC_LIST,PARAM_LIST,PARAM_DEC,VAR_DEF,DEC_LIST,DEF_LIST,COMP_STM,STM_LIST,EXP_STMT,IF_THEN,IF_THEN_ELSE, FUNC_CALL,ARGS, FUNCTION,PARAM,ARG,CALL,LABEL,GOTO,JLT,JLE,JGT,JGE,EQ,NEQ,ARRAY_VAR,STRUCT_VAR,FOR_CONDITION,EXT_ARR_DEF,ARR_LIST
,STRUCT_DEF_LIST,STRUCT_LIST,EXT_STRUCT_DEF,STRUCT_DEC,ARRAY_DEC,ARRAY_DEF};
